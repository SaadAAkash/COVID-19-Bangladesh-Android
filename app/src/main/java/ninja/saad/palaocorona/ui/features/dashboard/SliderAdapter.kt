...
class SliderAdapter(var source: String) : SliderViewAdapter<SliderAdapter.SliderViewHolder>() {
    ...
    val itemsDashboard = mutableListOf<Any>(R.drawable.ic_myth_slider_5_bn, R.drawable.ic_myth_slider_2_bn, R.drawable.ic_myth_slider_3_bn, R.drawable.ic_myth_slider_4_bn, R.drawable.ic_myth_slider_1_bn)
