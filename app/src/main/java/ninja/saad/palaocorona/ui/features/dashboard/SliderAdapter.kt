...
class SliderAdapter(var source: String, val language: String = "en") : SliderViewAdapter<SliderAdapter.SliderViewHolder>() {
    ...
    val itemsDashboardEn = mutableListOf<Any>(R.drawable.ic_myth_slider_5_bn, R.drawable.ic_myth_slider_2_bn, R.drawable.ic_myth_slider_3_bn, R.drawable.ic_myth_slider_4_bn, R.drawable.ic_myth_slider_1_bn)
    val itemsDashboardBn = mutableListOf<Any>(R.drawable.ic_myth_slider_5_en, R.drawable.ic_myth_slider_2_en, R.drawable.ic_myth_slider_3_en, R.drawable.ic_myth_slider_4_en, R.drawable.ic_myth_slider_1_en)
