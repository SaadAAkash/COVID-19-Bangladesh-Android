package xyz.palaocorona.ui.features.quarantine
...
import xyz.palaocorona.ui.features.dashboard.SliderAdapter

class QuarantineFragment: BaseFragment<BaseViewModel>()  {
